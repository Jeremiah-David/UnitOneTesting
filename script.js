...
let fransFlowers = [
  {
    ...
    rubricPoints: 1,
    attributes: [],
    styles: [["color", "rgb(65, 105, 225)", "!"], ["background-color", "rgb(255, 228, 196)", "!"], ["font-family", "Comic Sans MS", "!"]],
    levelUp: false,
  },
  {
    elements: ["header"],
    ...
    rubricPoints: [1],
    attributes: [],
    styles: [["color", "rgb(247, 86, 124)"], ["font-family", "Dancing Script"], ["font-size", "36px"]],
    levelUp: false,
  },
  {
    elements: ["hr"],
    ...
    rubricPoints: [1],
    attributes: [],
    styles: [["overflow", "visible"], ["padding", "0"], ["text-align", "center"]],
    levelUp: false,
  },
  {
    elements: ["h2"],
    ...
    rubricPoints: 1,
    attributes: [],
    styles: [["font-family", "Abril Fatface"], ["letter-spacing", "3px"]],
    levelUp: false,
  },
  {
    elements: ["#donation"],
...
let carpetCleaner = [
  ...
  },
  {
    ...
    rubricPoints: 1,
    attributes: [],
    styles: [["list-style", "none"], ["margin", "0"], ["padding", "20px 0px 0px"], ["text-align", "center"]],
    levelUp: false,
    levelUpFeedback: []
  },
  {
    ...
    rubricPoints: 1,
    attributes: [],
    styles: [["display", "inline-block"], ["padding", "20px"], ["margin", "0px 10px"]],
    levelUp: false,
    levelUpFeedback: []
  },
  {
  ...
  },
  {
    ...
    rubricPoints: 1,
    attributes: [],
    styles: [["display", "inline-block"], ["width", "400px"], ["height", "200px"], ["vertical-align", "top"], ["box-sizing", "border-box"]],
    levelUp: false,
    levelUpFeedback: [],
  },
  {
  ...
  },
  {
    ...
    rubricPoints: 1,
    attributes: [],
    styles: [["padding", "20px"], ["margin-top", "30px"], ["height", "200px"]],
    levelUp: false,
    levelUpFeedback: []
  },
  {
...
let portfolio = [
  ...
  },
  {
    ...
    passesNeeded: 1,
    rubricPoints: 1,
    styles: [["borderEndEndRadius", "0px", "!"], ["borderBlockWidth", "0", "!"]],
    lookingFor: `Should include a centered, circular headshot image with a border.`,
    levelUp: false,
    levelUpFeedback: []
  },
  {
    elements: ["#hero-section h1", "#hero-section h2", "#hero-section h3", "#hero-section h4", "#hero-section h5", "#hero-section h6"],
    passesNeeded: 2,
    rubricPoints: 1,
  ...
  // ******Inspiration*****
  {
    elements: ["#inspiration-section h1", "#inspiration-section h2", "#inspiration-section h3"],
    passesNeeded: 1,
    rubricPoints: 1,
    styles: [["textAlign", "center"]],
  ...
  // *****Mission Section*****
  {
    elements: ["#mission-section h1", "#mission-section h2", "#mission-section h3"],
    passesNeeded: 1,
    rubricPoints: 1,
    styles: [["textAlign", "center"]],
    lookingFor: `Should contain a centered heading.`,
  ...
  // *****Skill Section*****
  {
    elements: ["#skill-section h1", "#skill-section h2", "#skill-section h3", "#skill-section h4", "#skill-section h5", "#skill-section h6"],
    passesNeeded: 1,
    rubricPoints: 1,
    styles: [["textAlign", "center"]],
    lookingFor: `Should contain a centered heading.`,
  ...
  // ****Contact Section****
  {
    elements: ["#contact-section h1", "#contact-section h2", "#contact-section h3", "#contact-section h4", "#contact-section h5", "#contact-section h6"],
    passesNeeded: 1,
    rubricPoints: 1,
    styles: [["textAlign", "center"]],
    lookingFor: `Should contain a centered heading.`,
  ...
  // ***Footer Section***
  {
    elements: ["#footer-section h1", "#footer-section h2", "#footer-section h3", "#footer-section h4", "#footer-section h5", "#footer-section h6", "#footer-section p"],
    passesNeeded: 1,
    rubricPoints: 1,
    styles: [["textAlign", "center"]],
  ...
  for (let i = 0; i < resultsArray.length; i++) {
    if (resultsArray[i].length >= elementsNeededToPassRubric[i].passesNeeded) {
      ...
      if (elementsNeededToPassRubric[i].lookingFor !== undefined) {
        ...
        results.testsFailed.push(`The element ${elementsNeededToPassRubric[i].elements} did not pass our test`)
        results.testsFailed.push(`We tested for ${elementsNeededToPassRubric[i].lookingFor}`)
      } else {
        results.testsFailed.push(`The element ${elementsNeededToPassRubric[i].elements} did not pass our test.`);
      }
    }
...
function checkAttribute(iteration, element, rubric) {
  ...
  if (rubric.attributes === undefined) { return true }
...
function checkElementsStyles(iteration, element, rubric) {
  k = iteration;
  HTMLelement = document.querySelectorAll(element);
  if (rubric.styles === undefined) { return true }
  ...
  for (let i = 0; i < elems.length; i++) {
    ...
    for (let j = 0; j < elems[i].elements.length; j++) {
      ...
      for (let k = 0; k < element.length; k++) {
        if (element["length"] !== 0) {
          if (doesElementClose(elems[i].elements[j])
            &&
...
function feedBackFunc(milestone) {
  let standardMessage = `We ran tests of expected DOM elements and properties, and this work passed ${rubricPoints} out of ${milestone.length} or ${percentage(rubricPoints, milestone.length)}% of our tests.`
